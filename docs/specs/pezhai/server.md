...
surround the storage-engine behavior defined in `docs/specs/pezhai/storage-engine.md`.
...
- `docs/specs/pezhai/storage-engine.md` remains authoritative for storage-engine state, snapshots,
  WAL,
...
- storage-engine naming remains governed by `docs/specs/pezhai/storage-engine.md`
...
- `put`, `delete`, `get`, `scan`, `sync`, and `stats` preserve the engine semantics already
  defined in `docs/specs/pezhai/storage-engine.md` [BEHAVIORAL]
...
- engine-derived errors MUST reuse the same error-code names as
  `docs/specs/pezhai/storage-engine.md` [BEHAVIORAL]
...
- `Put` MUST preserve the `put()` semantics defined in
  `docs/specs/pezhai/storage-engine.md`
  [BEHAVIORAL]
